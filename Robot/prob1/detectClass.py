...
import threading
from robot_talking import robot_talking
...
class Detector:
    ...
    def __init__(self):
        ...
        self.privetstvie=["Привет", "Здраствуйте", "Добро пожаловать", "Рад вас видеть", "Хорошо выглядите"]
        self.RandomWord=["Когда роботы станут разумными, их деньги будут называться — киловатты.",
    ...
    def deleteimg(self):
        os.chdir(r"C:\Users\robosky\PycharmProjects\Robot\prob1\dataSet\\")
        l = os.listdir('.')
        for i in l:
    ...
    def train(self):
        os.chdir(r"C:\Users\robosky\PycharmProjects\Robot\prob1")
